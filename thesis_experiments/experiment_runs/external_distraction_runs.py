...
def define_policies():
    return [
        ...
        Policy('Policy 3', **{'level0_fraction': 0, 'level1_fraction': 0, 'level2_fraction': 0, 'level3_fraction': 1.0,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 4', **{'level0_fraction': 0.8, 'level1_fraction': 0.2, 'level2_fraction': 0, 'level3_fraction': 0,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 5', **{'level0_fraction': 0.6, 'level1_fraction': 0.2, 'level2_fraction': 0.2, 'level3_fraction': 0,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 6', **{'level0_fraction': 0.4, 'level1_fraction': 0.2, 'level2_fraction': 0.2, 'level3_fraction': 0.2,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 7', **{'level0_fraction': 0.25, 'level1_fraction': 0.25, 'level2_fraction': 0.25, 'level3_fraction': 0.25,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 8', **{'level0_fraction': 0, 'level1_fraction': 0.33, 'level2_fraction': 0.33, 'level3_fraction': 0.33,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 9', **{'level0_fraction': 0, 'level1_fraction': 0., 'level2_fraction': 0.5, 'level3_fraction': 0.5,
                              'in_vehicle_distraction': True, 'road_side_distraction': True}),
        Policy('Policy 10', **{'level0_fraction': 0, 'level1_fraction': 0, 'level2_fraction': 0.2, 'level3_fraction': 0.8,
                               'in_vehicle_distraction': True, 'road_side_distraction': True}),
    ]
...
if __name__ == '__main__':
    ...
    experiment_string = 'external_distraction'
    experiment_number = 1
