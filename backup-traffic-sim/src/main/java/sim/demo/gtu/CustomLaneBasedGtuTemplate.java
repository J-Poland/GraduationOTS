 ...
 */
public class CustomLaneBasedGtuTemplate extends GtuTemplate implements LaneBasedGtuCharacteristicsGenerator
{
    /** */
     ...
     *            direction).
     * @param maxAccelerationGenerator Generator&lt;Acceleration&gt;; generator for the maximum acceleration of the GTU type.
     * @param maxDecelerationGenerator Generator&lt;Acceleration&gt;; generator for the maximum deceleration of the GTU type.
     ...
     */
    public CustomLaneBasedGtuTemplate(final GtuType gtuType, final Generator<Length> lengthGenerator,
            final Generator<Length> widthGenerator, final Generator<Speed> maximumSpeedGenerator,
            final Generator<Acceleration> maxAccelerationGenerator, final Generator<Acceleration> maxDecelerationGenerator,
            final LaneBasedStrategicalPlannerFactory<?> strategicalPlannerFactory, final Generator<Route> routeGenerator)
            throws NullPointerException
    {
    	super(gtuType, lengthGenerator, widthGenerator, maximumSpeedGenerator, maxAccelerationGenerator, maxDecelerationGenerator);
