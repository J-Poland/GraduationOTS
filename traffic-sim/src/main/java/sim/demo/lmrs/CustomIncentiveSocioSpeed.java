...
/**
 * Own version of: Lane change incentive based on social pressure. Drivers may refrain from changing left to not hinder faster traffic, or
 ...
 * 
 * Another parameter than SOCIO is used for the sigma value.
 */
public class CustomIncentiveSocioSpeed implements VoluntaryIncentive
{
    ...
    /** Hierarchy parameter. */
    protected static final ParameterTypeDouble SOCIO_LANE = VehicleAutomationConfigurations.SOCIO_LANE;
            ...
            throws ParameterException, OperationalPlanException
    {
        ...
        {
            double sigma = parameters.getParameter(SOCIO_LANE);
